...
UBYTE ComIfChannelTxBuffer_Boot[256];

UBYTE ComIf_ShadowBuffer_Boot_Boot_Response[1];

ComIfTxMessageConfig ComIfTxMsgCfg_Boot[1] = {
	{
		/* Boot_Response */
		/* ID */        0xB5,
		/* Length */    1,
...
ComIfRxMessageConfig ComIfRxMsgCfg_Boot[1] = {
	{
		/* Boot_Req_Data */
		/* ID */      0xB3,
		/* Length */  21,
...
UBYTE ComIf_RxIndication_Boot(char * DataString, UWORD Length)
{
	return ComIf_RxIndication_ASCIIString(((UBYTE)C_ComIfChannel_Boot), DataString, Length);
}
