...
#define BkUpRam_Base_ADD					0x40036400 // this address is used to write the switch mode choose

#define BkUpRam_Verify_App_ADD		0x40036408 // this address is used to write data, to confirm the switch based on backup ram
